...
contract WitmonLiscon21 is IWitmonDecorator {
    ...
    struct Art {
        ...
        string[] eyeColor;
        string[] skinColor;
        mapping(uint256 => Item) trait1;
        // ...
        mapping(uint256 => Item) traitN;
    }
    ...
    function metadata(bytes32 _genotype, Witmons.Creature memory _creature)
        ...
        returns (string memory)
    {
		...
		// 		'"image_state": "', imageData(_tokenId), '",',
    ...
    function picture(bytes32 _genotype, Witmons.Creature memory _creature)
        external view override
        returns (string memory)
    {
    ...
    // 		internal pure returns (uint8[12] memory)
    // {
